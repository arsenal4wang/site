					...
					<div class="pubox_left">
						<div class="" style="">
							<div class="main_list_l left"
								...
								<h2>学院快讯</h2>
								<!-- <div class="scroll" id="xst" style="overflow: hidden;"></div> -->
								<div id="">
									<ul>
							...
							<div class="main_list_s left"
								...
								<div>
									...
									<p style="float: right;">
										<a
											href='getInfo?secID=<s:property value="%{s2.secID}"/>&navID=<s:property value="%{s2.secIDforSub}"/>&isNav=0&showUL=<s:property value="%{s2.showUL}"/>'>查看更多...</a>
									</p>
								</div>
							</div>
						</div>
											...
											<s:iterator value="listNews" id="news">
												<s:if test="%{#news.secSecID==#id.secID}">
													<li><s:a title="%{titleFake}" target="_blank"
															...
															<span style="float: right; width: 40px;"><s:property
																	value="%{subDate}" /></span>
